...
export default function ChatScreen() {
  ...
  const sendMessage = async () => {
    ...
    try {
      const backendApiUrl = "http://192.168.5.151:4000/api/v1/chat";
  ...
  const renderMessage = (msg: Message) => {
    ...
    return (
      <View key={msg.id} style={[styles.messageContainer, styles.aiMessage]}>
          ...
          {isLoading && (
            <View style={styles.loadingContainer}>
              ...
              <View style={styles.aiMessageBubble}>
                ...
                <Text style={styles.loadingText}>BuhAI is thinking...</Text>
              </View>
            </View>
          )}
        </ScrollView>
