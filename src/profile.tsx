  ...
  return (
    <ScrollView style={styles.profile_container}>
      <View style={styles.profileCard}>
        ...
        <TouchableOpacity
          onPress={() => sendNotification("Test", "This works!")}
        >
        ...
        <View style={styles.infoSection}>
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoItem}>
              <Text style={styles.infoLabel}>Average Glucose Level</Text>
          ...
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoValue}>FreeStyle Libre</Text>
            </View>
            <View style={styles.infoItem}>
              <Text style={styles.infoLabel}>SmartWatch</Text>
              <Text style={styles.infoValue}>Redmi Watch 5 Light</Text>
            </View>
          </View>
          ...
          <View style={styles.contactSection}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoItem}>
                <Text style={styles.infoLabel}>Iben E. Anoos</Text>
                <Text style={styles.infoValue}>09918750974</Text>
              </View>
            </View>

            <View style={styles.infoRow}>
              <View style={styles.infoItem}>
                <Text style={styles.infoLabel}>Jake Bajenting</Text>
                <Text style={styles.infoValue}>09562461476</Text>
              </View>
            </View>
          </View>
        </View>
