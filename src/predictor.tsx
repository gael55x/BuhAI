  ...
  const getPredictionAnalysis = () => {
    ...
    if (avgPredicted > 180) {
      return {
        ...
        color: "#ef4444",
        advice:
          "Your glucose is predicted to rise above target range. Consider checking your recent meal intake or activity level.",
      ...
      return {
        ...
        color: "#ef4444",
        advice:
          "Your glucose may drop below target range. Consider having a small snack if you feel symptoms.",
      ...
      return {
        ...
        color: "#10b981",
        advice:
          "Your glucose levels are predicted to remain in a healthy range over the next 30 minutes.",
        icon: "trending-up",
      };
    }
  };
  ...
  return (
    ...
    >
      ...
      <View style={styles.predictor_header}>
        ...
        <Text style={styles.headerSubtitle}>AI-powered 30-minute forecast</Text>
      </View>
      ...
      <View style={styles.analysisCard}>
        <View style={styles.analysisHeader}>
          ...
          />
          <Text style={styles.analysisTitle}>Prediction Analysis</Text>
        </View>

        <View style={styles.trendContainer}>
          <Text style={styles.trendLabel}>Predicted Trend:</Text>
          <Text style={[styles.trendValue, { color: analysis.color }]}>
            {analysis.trend}
          </Text>
        </View>
        ...
        <View style={styles.predictionDetails}>
          <View style={styles.detailItem}>
            ...
            <Text style={styles.detailValue}>{currentGlucose} mg/dL</Text>
          </View>
          <View style={styles.detailItem}>
        ...
        <View style={styles.insightsList}>
          <View style={styles.insightItem}>
            <Text style={styles.insightText}>
              • Based on your recent patterns, glucose tends to rise slightly
              after this time of day
            </Text>
          </View>
          <View style={styles.insightItem}>
            <Text style={styles.insightText}>
              • Your last meal was 2 hours ago, which may contribute to the
              predicted trend
            </Text>
          </View>
          <View style={styles.insightItem}>
            <Text style={styles.insightText}>
              • Consider light activity to help maintain stable levels
            </Text>
          </View>
        </View>
      </View>
